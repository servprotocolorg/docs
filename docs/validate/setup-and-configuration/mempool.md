...
SERV supports [EIP-1559](https://eips.ethereum.org/EIPS/eip-1559#simple-summary) EVM transactions through its
...
To use the a prioritized mempool, adjust `version = "v1"` in the node configuration at `~/.serv/config/config.toml`.
