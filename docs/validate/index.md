...
SERV is based on [CometBFT](https://github.com/cometbft/cometbft),
...
holders. The SERV is SERV's native token. At its onset, SERV launche with 150 validators. The validators are
determined by who has the most stake delegated to them - the top 150 validator candidates with the most stake
become part of the active SERV validator set.

Validators and their delegators will earn SERV as block provisions and tokens as transaction fees through execution of
the Tendermint consensus protocol. Initially, transaction fees will be paid in SERV but in the future, any token in the
...
If validators double sign, are frequently offline or do not participate in governance, their staked SERV (including
SERV of users that delegated to them) can be slashed. The penalty depends on the severity of the violation.
...
Discord. This is important since users will want to have information about the entity they are staking their SERV to.
