...
(via IBC) and interact with core functionalities on the SERV chain (e.g. staking, voting) from the EVM.
...
<!-- 
:::tip
**Note**: Find the EVM Extensions Solidity interfaces and examples in the [SERV Extensions repo](https://github.com/evmos/extensions).
::: -->
