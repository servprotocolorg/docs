...
Find the [Solidity interface in theserv/extensions repo](https://github.com/evmos/extensions/blob/main/precompiles/stateful/Distribution.sol).

### ABI

Find the [ABI in theserv/extensions repo](https://github.com/evmos/extensions/blob/main/precompiles/abi/distribution.json).
