...
:::note
An SERV supportor, Yogurt.rocks, runs a [faucet](https://www.yogurt.rocks/faucet/) for builders to request dust.
:::

## Deployment

You can deploy your contracts on Mainnet using the [JSON-RPC](../develop/smart-contracts#deploy-with-ethereum-json-rpc).
This is the same procedure as on Testnet, but instead targeting the [Network endpoints](./../develop/api/networks).
Before you do so, have a look at the following considerations.

### Security

Thoroughly test your smart contracts on the SERV Testnet to ensure it operates as intended. Comprehensive tests should
...
eligible receivers of an airdrop have a look at the [SERV Rektdrop](https://medium.com/evmos/the-evmos-rektdrop-abbe931ba823).

### Token Registration

SERV allows for ERC-20 tokens to be used cross-chain. Once some of your tokens have been minted, you can register a token
...
On SERV, you can generate revenue, every time a user interacts with your dApp,
...
Make yourself heard in the SERV community and explain what value your dApp provides.
...
Head over to the [SERV Discord](https://discord.gg/cXv3SnmegZ) channel get in touch with the community and contributors and
showcase your dApp on one of the next community calls. We also have a [Telegram group](https://t.me/+pCUVkj9zd4s0MzIx) for
our builders.
