...
To add SERV to Metamask, head over [here](https://chainlist.org/?testnets=true&search=serv) to add Testnet and Mainnet.
:::

The SERV Testnet is a decentralized blockchain network
...
It is run by Validators using the same software as on the SERV Mainnet,
...
Using the SERV Testnet provides several benefits for dApp developers.
...
Secondly, the SERV Testnet provides a community-driven
...
The SERV Testnet [Faucet](https://faucet.evmos.dev/) distributes small amounts
...
- **Bech32**: [`sx1ht560g3pp729z86s2q6gy5ws6ugnut8r4uhyth`](https://testnet.mintscan.io/evmos-testnet/account/sx1ht560g3pp729z86s2q6gy5ws6ugnut8r4uhyth)
