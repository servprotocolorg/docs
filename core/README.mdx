...
# Welcome CORE Developers

SERV is an fast and decentralized blockchain. Our mainnet runs Ethereum applications with 5-second transaction finality, lower fees and completely decentralized from it's start.

SERV is your open platform for assets, collectibles, identity, governance.&#x20;

## Build on SERV Protocol
